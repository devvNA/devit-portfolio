...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center pt-16 px-4 sm:px-6 lg:px-8 py-12 sm:py-20 overflow-hidden"
    >
      {/* Background gradient with cyber effect */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[var(--neon-primary)]/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[var(--neon-secondary)]/5 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[var(--tertiary)]/3 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full text-center">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 tracking-tight"
          >
          ...
          <motion.h2
            ...
            className="text-lg sm:text-2xl md:text-3xl text-[var(--text-light)] mb-6 font-medium"
          >
            Mobile Developer
          </motion.h2>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-[var(--text-light)] mb-8 leading-relaxed max-w-2xl mx-auto"
          >
          ...
          >
            ...
            <a
              href="#projects"
              className="btn btn-outline px-6 py-3 min-h-[44px] text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--neon-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
            >
              View Projects
            </a>
          </motion.div>
