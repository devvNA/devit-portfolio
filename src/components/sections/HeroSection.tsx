      ...
      <div className="max-w-4xl mx-auto w-full text-center">
        ...
        >
          ...
          >
            <a
              href="#contact"
              className="btn btn-primary px-6 py-3 min-h-[44px] text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
            >
              Get In Touch
            </a>
            <a
              href="#projects"
              className="btn btn-outline px-6 py-3 min-h-[44px] text-sm hover:border-[var(--accent)] hover:text-[var(--accent)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
            >
              View Projects
            </a>
          </motion.div>
