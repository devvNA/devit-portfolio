  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-[var(--neon-primary)]/5 rounded-full blur-2xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[var(--neon-secondary)]/5 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto w-full text-center">
        ...
        >
          ...
          >
            <Badge variant="neon-secondary">Welcome to my portfolio</Badge>
          </motion.div>
